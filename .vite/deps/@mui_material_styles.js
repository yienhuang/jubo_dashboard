...
import {
  ...
  U as deepmerge,
  V as styleFunctionSx_default,
  W as require_prop_types,
  _ as InitColorSchemeScript$1,
  a as createTheme,
  c as shouldSkipGeneratingVar,
  d as createTransitions,
  f as duration,
  g as createCssVarsProvider,
  h as createMixins,
  i as defaultTheme,
  j as rgbToHex,
  k as lighten,
  l as createColorScheme,
  m as createTypography,
  n as useTheme,
  o as createThemeWithVars,
  p as easing,
  r as identifier_default,
  s as excludeVariablesFromRoot,
  t as styled,
  u as getOverlayAlpha,
  v as ThemeProvider$1,
  w as emphasize,
  x as alpha,
  z as createCache,
} from './styled-CVsIbdWg.js'
...
function StyledEngineProvider(props) {
  ...
  return cache
    ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CacheProvider, {
        value: cache,
        children,
      })
    : children
...
function Experimental_CssVarsProvider(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InternalCssVarsProvider, {
    ...props,
  })
}
...
function ThemeProvider({ theme, ...props }) {
  ...
  if (noVarsTheme)
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThemeProviderNoVars, {
      theme: noVarsTheme,
      ...props,
    })
...
export {
  ...
  excludeVariablesFromRoot as private_excludeVariablesFromRoot,
  recomposeColor,
  responsiveFontSizes,
  rgbToHex,
