...
function deepClone(source) {
  if (
    /* @__PURE__ */ import_react.isValidElement(source) ||
...
function deepmerge(target, source, options = { clone: true }) {
  ...
  if (isPlainObject(target) && isPlainObject(source))
    Object.keys(source).forEach((key) => {
      if (
        /* @__PURE__ */ import_react.isValidElement(source[key]) ||
...
function sortContainerQueries(theme, css) {
  ...
  keys.sort((a, b) => {
    return (
      +(a.match(MIN_WIDTH_PATTERN)?.[1] || 0) - +(b.match(MIN_WIDTH_PATTERN)?.[1] || 0)
    )
  })
  const result = css
  ...
  if (typeof propValue === 'object') {
    ...
    for (const key in propValue)
      if (isCqShorthand(breakpoints.keys, key)) {
        ...
        buildBreakpoint(target, breakpoints.up(key), propValue[key], key, callback)
      else {
        const cssKey = key
...
function hasBreakpoint(breakpoints, value) {
  ...
  if (typeof value === 'object' && value !== null) {
    for (let i = 0; i < breakpoints.keys.length; i += 1)
      if (breakpoints.keys[i] in value) return true
    const valueKeys = Object.keys(value)
    for (let i = 0; i < valueKeys.length; i += 1)
      if (isCqShorthand(breakpoints.keys, valueKeys[i])) return true
  }
  return false
}
//#endregion
...
function compose(...styles) {
  ...
  const fn = (props) => {
    const result = {}
    for (const prop in props)
      if (handlers[prop]) fastDeepAssign(result, handlers[prop](props))
    return result
  }
...
compose(
  ...
  columnGap,
  rowGap,
  style$1({ prop: 'gridColumn' }),
  style$1({ prop: 'gridRow' }),
  style$1({ prop: 'gridAutoFlow' }),
  style$1({ prop: 'gridAutoColumns' }),
  style$1({ prop: 'gridAutoRows' }),
  style$1({ prop: 'gridTemplateColumns' }),
  style$1({ prop: 'gridTemplateRows' }),
  style$1({ prop: 'gridTemplateAreas' }),
  style$1({ prop: 'gridArea' }),
)
//#endregion
...
var maxWidth = (props) => {
  if (props.maxWidth !== void 0 && props.maxWidth !== null) {
    const styleFromPropValue = (propValue) => {
      const breakpoint =
        props.theme?.breakpoints?.values?.[propValue] || values[propValue]
      if (!breakpoint) return { maxWidth: sizingTransform(propValue) }
      if (props.theme?.breakpoints?.unit !== 'px')
        return { maxWidth: `${breakpoint}${props.theme.breakpoints.unit}` }
      ...
      if (!nested && theme.modularCssLayers)
        return {
          '@layer sx': sortContainerQueries(
            theme,
            removeUnusedBreakpoints(breakpoints, css),
          ),
        }
    ...
    switch (((previous = character), (character = next()))) {
      case 40:
        if (previous != 108 && charat(characters, length - 1) == 58) {
          if (
            indexof((characters += replace(delimit(character), '&', '&\f')), '&\f') != -1
          )
            ampersand = -1
          break
        }
  ...
  var finalizingPlugins = [
    ...
    function (element) {
      if (!element.root) {
        ...
        else if (element.value && element.type !== 'comm')
...
var require_hoist_non_react_statics_cjs = /* @__PURE__ */ __commonJSMin(
  (exports, module) => {
...
var registerStyles = function registerStyles(cache, serialized, isStringTag) {
  ...
  if (
    (isStringTag === false || isBrowser$1 === false) &&
...
var EmotionCacheContext = /* @__PURE__ */ import_react.createContext(
...
var Emotion = /* @__PURE__ */ withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = serializeStyles(
    registeredStyles,
    void 0,
    import_react.useContext(ThemeContext$1),
  )
  ...
  return /* @__PURE__ */ import_react.createElement(
    ...
    null,
    /* @__PURE__ */ import_react.createElement(Insertion$2, {
      cache,
      serialized,
...
var ClassNames = /* @__PURE__ */ withEmotionCache(function (props, cache) {
  ...
  return /* @__PURE__ */ import_react.createElement(
    import_react.Fragment,
    null,
    /* @__PURE__ */ import_react.createElement(Insertion$1, {
      cache,
      serializedArr,
    }),
    ele,
  ...
  return function () {
    ...
    var Styled = withEmotionCache(function (props, cache, ref) {
      ...
      return /* @__PURE__ */ import_react.createElement(
        import_react.Fragment,
        null,
        /* @__PURE__ */ import_react.createElement(Insertion, {
          cache,
          serialized,
...
function createSpacing(
  spacingInput = 8,
  transform = createUnarySpacing({ spacing: spacingInput }),
) {
  ...
  const spacing = (...argsInput) => {
    ...
    return (argsInput.length === 0 ? [1] : argsInput)
      .map((argument) => {
...
function attachTheme(props, themeId, defaultTheme) {
  props.theme = isObjectEmpty$1(props.theme)
    ? defaultTheme
...
function processStyleVariants(props, variants, results = [], layerName = void 0) {
  ...
  variantLoop: for (let i = 0; i < variants.length; i += 1) {
    ...
    if (typeof variant.style === 'function') {
      ...
      results.push(
        layerName
          ? shallowLayer(internal_serializeStyles(variant.style), layerName)
          : variant.style,
      )
  }
  return results
...
function createStyled(input = {}) {
  ...
  const styled = (tag, inputOptions = {}) => {
    internal_mutateStyles(tag, (styles) =>
      styles.filter((style) => style !== styleFunctionSx_default),
    )
    const {
      name: componentName,
      slot: componentSlot,
      ...
      if (typeof style === 'function')
        return function styleFunctionProcessor(props) {
          return processStyle(
            props,
            style,
            props.theme.modularCssLayers ? layerName : void 0,
          )
        }
    ...
    const muiStyledResolver = (...expressionsInput) => {
      ...
      const Component = defaultStyledResolver(
        ...[...expressionsHead, ...expressionsBody, ...expressionsTail],
      )
...
function useCurrentColorScheme(options) {
  ...
  const modeStorage = import_react.useMemo(
    () =>
      storageManager?.({
        key: modeStorageKey,
        storageWindow,
  ...
  const lightStorage = import_react.useMemo(
    () =>
      storageManager?.({
  ...
  const darkStorage = import_react.useMemo(
    () =>
      storageManager?.({
  ...
  const setMode = import_react.useCallback(
    (mode) => {
  ...
  const setColorScheme = import_react.useCallback(
    (value) => {
      if (!value)
        setState((currentState) => {
  ...
  const handleMediaQuery = import_react.useCallback(
    (event) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () =>
    import_react.useContext(ColorSchemeContext) || defaultContext
  ...
  function CssVarsProvider(props) {
    ...
    const joinedColorSchemes = Object.keys(colorSchemes)
      ...
      .join(',')
    const allColorSchemes = import_react.useMemo(
    ...
    const element = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react.Fragment, {
      children: [
        ...
        shouldGenerateStyleSheet &&
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GlobalStyles$1, {
  ...
  function defaultGetSelector(colorScheme, cssObject) {
    ...
    if (colorScheme) {
      if (rule === 'media') {
        ...
        return {
          [`@media (prefers-color-scheme: ${colorSchemes[colorScheme]?.palette?.mode || colorScheme})`]:
            { ':root': cssObject },
        }
      }
      if (rule) {
...
var createGetSelector_default = (theme) => (colorScheme, css) => {
  ...
  if (theme.defaultColorScheme === colorScheme) {
    ...
    if (rule === 'media')
      return {
        [`@media (prefers-color-scheme: ${String(colorScheme)})`]: { [root]: css },
      }
...
function createThemeWithVars(options = {}, ...args) {
  ...
  const muiTheme = attachColorScheme$1(
    colorSpace,
    colorSchemes,
    defaultScheme,
    input,
      ...
      if (
        ...
        if (colors.main)
          setColor(
            palette[color],
            'mainChannel',
            private_safeColorChannel(toRgb(colors.main)),
          )
        if (colors.light)
          setColor(
            palette[color],
            'lightChannel',
            private_safeColorChannel(toRgb(colors.light)),
          )
        if (colors.dark)
          setColor(
            palette[color],
            'darkChannel',
            private_safeColorChannel(toRgb(colors.dark)),
          )
...
function createTheme(options = {}, ...args) {
  const {
    palette,
    cssVariables = false,
    colorSchemes: initialColorSchemes = !palette ? { light: true } : void 0,
...
export {
  ...
  CacheProvider as R,
  darken as S,
  getContrastRatio as T,
  deepmerge as U,
  styleFunctionSx_default as V,
  require_prop_types as W,
  InitColorSchemeScript as _,
  createTheme as a,
  useDefaultProps as b,
  shouldSkipGeneratingVar as c,
  createTransitions as d,
  duration as f,
  createCssVarsProvider as g,
  createMixins as h,
  defaultTheme as i,
  rgbToHex as j,
  lighten as k,
  createColorScheme as l,
  createTypography as m,
  useTheme as n,
  createThemeWithVars as o,
  easing as p,
  identifier_default as r,
  excludeVariablesFromRoot as s,
  styled as t,
  getOverlayAlpha as u,
  ThemeProvider as v,
  emphasize as w,
  alpha as x,
  DefaultPropsProvider as y,
  createCache as z,
}

//# sourceMappingURL=styled-CVsIbdWg.js.map
