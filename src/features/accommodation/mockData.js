...
export const overviewKpis = [
  {
    ...
    value: '$858',
    unit: '萬',
    delta: { dir: 'up', text: 'YoY +15.8%', isWarning: false },
  },
  {
    key: 'serviceTotal',
    title: '當月總服務人數',
  ...
  series: [
    {
      ...
      dashed: true,
      data: [
        87.9, 87.3, 86.6, 86.2, 87.5, 87.6, 88.1, 88.3, 89.2, 90.1, 89.1, 90.3, 90.6,
      ],
    },
    {
      name: '台北信義長照分院',
      color: '#0097A7',
      data: [
        94.1, 93.6, 94.8, 94.2, 95.3, 94.6, 95.8, 95.0, 95.5, 96.1, 95.2, 95.9, 96.2,
      ],
    },
    {
      name: '台中南屯長照分院',
      color: '#00838F',
      data: [
        84.2, 85.1, 83.5, 85.6, 86.4, 85.0, 86.8, 85.5, 86.7, 87.5, 86.2, 87.8, 87.6,
      ],
    },
    {
      name: '高雄左營長照分院',
      color: '#26A69A',
      data: [
        79.1, 76.5, 73.2, 70.5, 72.8, 76.1, 73.8, 77.5, 78.9, 80.5, 79.6, 81.4, 82.3,
      ],
    },
  ],
}
...
export const branchData = {
  台北信義長照分院: {
    ...
    warehouse: {
      ...
      categoryBreakdown: [
        { name: '藥品', value: 108, color: '#0097A7' },
        { name: '耗材', value: 82, color: '#00838F' },
        { name: '營養品', value: 58, color: '#26A69A' },
    ...
    financeKpis: [
      ...
      },
      {
        ...
        value: '$378',
        unit: '萬',
        delta: { dir: 'flat', text: '回收率 86.3%', isWarning: false },
      },
      {
        key: 'overdue',
        title: '逾期應收',
        value: '$60',
        unit: '萬',
        delta: { dir: 'up', text: '逾期率 13.7%', isWarning: true },
      },
      {
        key: 'staffCost',
        title: '人事費用',
  ...
  台中南屯長照分院: {
    ...
    warehouse: {
      ...
      categoryBreakdown: [
        { name: '藥品', value: 62, color: '#0097A7' },
        { name: '耗材', value: 46, color: '#00838F' },
        { name: '營養品', value: 32, color: '#26A69A' },
    ...
    financeKpis: [
      {
        ...
        value: '$198',
        unit: '萬',
        delta: { dir: 'up', text: 'YoY +22.4%', isWarning: false },
      },
      {
        key: 'collected',
        title: '已收款',
        value: '$172',
        unit: '萬',
        delta: { dir: 'flat', text: '回收率 86.9%', isWarning: false },
      },
      {
        key: 'overdue',
        title: '逾期應收',
        value: '$26',
        unit: '萬',
        delta: { dir: 'up', text: '逾期率 13.1%', isWarning: true },
      },
      {
        key: 'staffCost',
        title: '人事費用',
  ...
  高雄左營長照分院: {
      ...
      series: [
        {
          name: '新入住',
          color: '#0097A7',
          data: [2, 3, 2, 3, 2, 3, 2, 4, 2, 3, 3, 2, 2],
        },
    ...
    warehouse: {
      ...
      categoryBreakdown: [
        { name: '藥品', value: 58, color: '#0097A7' },
        { name: '耗材', value: 42, color: '#00838F' },
        { name: '營養品', value: 30, color: '#26A69A' },
    ...
    financeKpis: [
      {
        ...
        value: '$222',
        unit: '萬',
        delta: { dir: 'up', text: 'YoY +7.8%', isWarning: false },
      },
      {
        key: 'collected',
        title: '已收款',
        value: '$194',
        unit: '萬',
        delta: { dir: 'flat', text: '回收率 87.4%', isWarning: false },
      },
      {
        key: 'overdue',
        title: '逾期應收',
        value: '$28',
        unit: '萬',
        delta: { dir: 'up', text: '逾期率 12.6%', isWarning: true },
      },
      {
        key: 'staffCost',
        title: '人事費用',
